...
interface PuzzleTwoProps {
    onClickForward: (completedPuzzle: number) => void
}
export const PuzzleTwo = ({onClickForward}: PuzzleTwoProps) => {
            ...
            <div style={{width: '100%', height: '90%', display: 'flex', flexWrap: 'wrap', placeContent: 'space-between center'}}>
                ...
                atLocation ? 
                    ...
                    <>
                        <HandwrittenNote
                            color={'#383838'}
                            text={"Seek the home where first the story of Gaia dancing 'round her grandson was told."}
                            type={'quick'}
                            size="20px"
                        />
